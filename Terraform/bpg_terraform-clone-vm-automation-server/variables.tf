...
# vm_mac_addresses = {
#   "vm-9999" = "AA:BB:CC:DD:99:99"  # null  # Optional, can be omitted or set to null
# }

# vm_ip_addresses = {
#   "vm-9999" = "192.168.1.240/24"  # "dhcp"  # Optional, can be omitted or set to "dhcp"
# }

# vm_gateways = {
#   "vm-9999" = "192.168.1.254"   # gateway omitted or set to "dhcp"
# }